...
[![GoDoc](https://godoc.org/github.com/ppcsuite/ppcwallet/walletdb?status.png)]
(http://godoc.org/github.com/ppcsuite/ppcwallet/walletdb)
...
http://localhost:6060/pkg/github.com/ppcsuite/ppcwallet/walletdb

## Installation

```bash
$ go get github.com/ppcsuite/ppcwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/ppcsuite/ppcwallet/walletdb#example-package--BasicUsage)  
